...
public class BoardsApi extends AbstractApi {
    ...
    public Board getGroupBoard(Object groupIdOrPath, Long boardId) throws GitLabApiException {
        Response response =
                get(Response.Status.OK, null, "groups", getGroupIdOrPath(groupIdOrPath), "boards", boardId);
        return (response.readEntity(Board.class));
    }
    ...
    public Board createGroupBoard(Object groupIdOrPath, String name) throws GitLabApiException {
        GitLabApiForm formData = new GitLabApiForm().withParam("name", name, true);
        Response response = post(
                Response.Status.CREATED, formData.asMap(), "groups", getGroupIdOrPath(groupIdOrPath), "boards");
        return (response.readEntity(Board.class));
    }
     ...
     * @throws GitLabApiException if any exception occurs
     */
    public BoardList updateGroupBoard(
     ...
     * @throws GitLabApiException if any exception occurs
     */
    public BoardList createGroupBoardList(Object groupIdOrPath, Long boardId, Long labelId) throws GitLabApiException {
        GitLabApiForm formData = new GitLabApiForm().withParam("label_id", labelId, true);
        Response response = post(
                Response.Status.CREATED,
                formData,
